...
public class Mochila extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnProcesar(ActionEvent arg0) {
		...
		else if(impP>=500 && impP <700){Choco=8*cant;}
		else {Choco=10;}
			

		txtS.setText("EL IMPÖRTE DE LA COMPRA ES : " + decimalFormat (impC)+"\n");
			 imprimo("EL IMPORTE DE DESCUENTO ES : " + decimalFormat(impD));
			 imprimo("EL IMPPORTE A PAGAR        : " + decimalFormat(impP));
			 imprimo("LA CANTIDAD DE CHOCOLATES  : " + Choco);
