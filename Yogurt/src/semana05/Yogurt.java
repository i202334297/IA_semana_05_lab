...
public class Yogurt extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnProcesar(ActionEvent arg0) {
		double impC,impD,impP,prec;
		int cant,marca,caramelos;
		...
		if (marca == 0){prec=5.4;}
		else if (marca ==1){prec=5.7;}
		else if (marca ==2){prec=4.8;}
		else {prec=5.3;}
		...
		else if (cant>=6 && cant <12){impD=impC*0.025;}
		else {impD=impC*0.075;}
		
		impP=impC-impD;
		
		if (marca==0){caramelos=cant*2;}
		else if(marca==1){caramelos=cant*3;}
		else if(marca==2){caramelos=cant*4;}
		else{caramelos=cant*2;}
		
		
		txtS.setText("EL IMPORTE DE COMPRA       : " + decimalFormat (impC)+"\n");
		 	 imprimo("EL IMPORTE DE DESCUENTO    : " + decimalFormat(impD));
		 	 imprimo("EL IMPPORTE A PAGAR        : " + decimalFormat(impP));
		 	 imprimo("LA CANTIDAD DE CARAMELOS   : " + caramelos);
