...
public class Libreria extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnProcesar(ActionEvent arg0) {
		...
		if      (marca==0){prec=4.85;}
		else if (marca==1){prec=4.35;}
		else if (marca==2){prec=3.50;}
		else              {prec=4.55;}
		...
		txtS.setText("EL IMPÖRTE DE LA COMPRA :S/ " + decimalFormat (impC)+"\n");
		 	 imprimo("EL IMPORTE DE DESCUENTO :S/ " + decimalFormat(impD));
		 	 imprimo("EL IMPPORTE A PAGAR     :S/ " + decimalFormat(impP));
